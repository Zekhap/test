...
import { AuthService } from 'public/services/index';
...
export class AppHeaderComponent implements OnInit, OnDestroy {
    ...
    @Input() navbarBrandText: any = {icon: '', text: 'Logo'};
    ...
    constructor(@Inject(DOCUMENT) private document: any, private renderer: Renderer2, private authService: AuthService, private router: Router) {
